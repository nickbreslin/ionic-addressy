    ...
    */
    pca.CountryList = function (fields, options) {
        ...
        * @type {Array.<Object>} */
        ...
        countrylist.options.fallbackCode = countrylist.options.fallbackCode || "USA";
    ...
    */
    pca.Address = function (fields, options) {
        ...
        * @type {string} */
        ...
        address.options.brand = address.options.brand || "Addressy" || "PostcodeAnywhere";
        address.options.product = address.options.product || "Addressy";
        ...
        var overrideAccount = "";
        if (pca && pca.initial && pca.initial.accountCode) {
            overrideAccount = pca.initial.accountCode;
        }
        address.options.bar.visible = typeof address.options.bar.visible == "boolean" ? address.options.bar.visible : ("Addressy" === "Addressy" && overrideAccount !== "DORMI11113" ? true : false);
        address.options.bar.showCountry = typeof address.options.bar.showCountry == "boolean" ? address.options.bar.showCountry : ("Addressy" === "Addressy" ? false : true);
        ...
        address.options.bar.logoClass = address.options.bar.logoClass || "adsylogo" || "pcalogo";
        address.options.bar.logoTitle = address.options.bar.logoTitle || "Powered by www.addressy.com";
        address.options.bar.logoUrl = address.options.bar.logoUrl || "http://www.addressy.com/";
        ...
        * @fires search */
        address.search = function (term) {
            ...
            if (search.searchTerm) {
                var searchParameters = { Key: address.key, Text: search.searchTerm, Origin: address.country, Language: address.language, Container: search.lastId, Filter: address.filteringMode, Instance: address.instance, Test: address.testMode, $block: address.blockSearches, $cache: address.cacheRequests };
                ...
                if (search.options.language)
                    searchParameters.Language = search.options.language;

                if (search.options.limit)
                    searchParameters.Limit = search.options.limit;

                if (search.options.countries)
                    searchParameters.Countries = search.options.countries;

                if (search.options.datasets)
                    searchParameters.Datasets = search.options.datasets;
